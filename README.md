...
<div class="marquee-strip">
  <div class="marquee-track">
    ...
    <div class="marquee-item">Afrique · Europe</div>
...
<section class="discovery">
  <div class="container">
    <div class="discovery-inner">
      ...
      <p>Un échange pour clarifier si le Diagnostic R.P.T. est fait pour vous.</p>
      <a href="https://www.linkedin.com/in/ines-kouki-transformation-consultant/" target="_blank" rel="noopener noreferrer" class="discovery-link">→ Réserver sur LinkedIn</a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="situations-grid">
      <div class="situation">
        ...
        <p>Ce que votre rôle demande a changé. Vous ne savez pas si vos compétences d'hier sont encore suffisantes dans la nouvelle configuration.</p>
      </div>

      <div class="situation">
        <div class="situation-number">02</div>
        <h3>Vous stagnez malgré votre compétence</h3>
        <p>Vous livrez. Votre manager le sait. Mais les opportunités passent à côté de vous. Vous voyez des collègues moins expérimentés progresser plus vite. Ce n'est pas une question de compétence.</p>
      </div>

      <div class="situation">
        <div class="situation-number">03</div>
        <h3>Votre expertise deviendra-t-elle obsolète ?</h3>
      ...
      <div class="situation">
        ...
        <p>Vous portez beaucoup : coordination, facilitation et résolution de tensions. Cette contribution est rarement formalisée et encore moins reconnue aux bons endroits.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="pillars-grid">
      ...
      <div class="pillar">
        ...
        <p class="pillar-intro">Deux personnes avec le même rôle peuvent avoir des impacts opposés. La différence ne tient pas à la compétence. Elle tient à la posture : présence, autorité naturelle, capacité d'influence.</p>
        <ul class="pillar-questions">
        ...
        <div class="pillar-benefit">
          ✓ Influence sans effort excessif.
      ...
      <div class="pillar">
        ...
        <p class="pillar-intro">De nombreux professionnels enchaînent les missions sans direction claire. Fatigue, stagnation, perte de sens. La trajectoire se construit intentionnellement ou elle vous échappe.</p>
        <ul class="pillar-questions">
    ...
    <div class="ba-grid">
      <div class="ba-row">
        <div class="ba-cell before">
          ...
          <div class="ba-problem">« Mon rôle a changé. Je ne sais plus où me situer. »</div>
        </div>
      ...
      <div class="ba-row">
        <div class="ba-cell before">
          <div class="ba-label">Avant R.P.T.</div>
          <div class="ba-problem">« Je stagne malgré mes compétences. Je ne comprends pas pourquoi. »</div>
        </div>
        <div class="ba-cell after">
          <div class="ba-label">Après R.P.T.</div>
          <div class="ba-solution">
      ...
      <div class="ba-row">
        <div class="ba-cell before">
          <div class="ba-label">Avant R.P.T.</div>
          <div class="ba-problem">« L'IA progresse. Mon expertise sera-t-elle encore pertinente ? »</div>
        </div>
        <div class="ba-cell after">
          <div class="ba-label">Après R.P.T.</div>
          <div class="ba-solution">
      ...
      <div class="ba-row">
        <div class="ba-cell before">
          <div class="ba-label">Avant R.P.T.</div>
          <div class="ba-problem">« J'enchaîne les missions sans construire de trajectoire réelle. »</div>
        </div>
        <div class="ba-cell after">
          <div class="ba-label">Après R.P.T.</div>
          <div class="ba-solution">
      ...
      <div class="ba-row">
        <div class="ba-cell before">
          <div class="ba-label">Avant R.P.T.</div>
          <div class="ba-problem">« Je contribue énormément, mais cela ne se voit pas. »</div>
        </div>
        <div class="ba-cell after">
          <div class="ba-label">Après R.P.T.</div>
          <div class="ba-solution">
  ...
  <div class="about-wrapper">
    ...
    <div class="about-photo-col">
      ...
      <div class="about-stats">
        <div class="about-stat">
          ...
          <div class="about-stat-label">Pays · Afrique · Europe</div>
        </div>
        <div class="about-stat">
          <div class="about-stat-num">3</div>
          <div class="about-stat-label">Secteurs · Banque · Retail · Tech</div>
        </div>
        <div class="about-stat">
    ...
    <div class="about-content-col">
      ...
      <h2 class="about-title">
        Je clarifie ce que<br>les <em>frameworks</em><br>ne clarifient jamais.
      </h2>

      <div class="about-divider-h"></div>

      <div class="about-body">
        <p>J'ai grandi entre cultures et appris à naviguer dans des environnements multiculturels. Mes missions au sein de grandes organisations — dont <strong>BNP Paribas</strong> et <strong>Société Générale</strong> — m'ont permis de voir ce que les consultants externes ne voient jamais.</p>

        <p>4 pays. 3 secteurs. À chaque transition, j'ai dû décoder les règles non écrites : comment s'affirmer, comment être vue, comment rester pertinente quand tout autour de vous se reconfigure.</p>

        <p>J'ai commencé par le <strong>marketing</strong>, où j'ai appris à comprendre les personnes, à créer de l'adhésion et à traduire la complexité en clarté. Ces compétences sont devenues le cœur de mon approche de la transformation.</p>
      </div>

      <blockquote class="about-quote">
        « La transformation ne réussit pas grâce aux seules méthodes. Elle réussit quand les acteurs clés savent clairement quelle est leur place — et la place qu'ils veulent construire. »
      </blockquote>
      ...
      <div class="about-certs">
        ...
        <div class="about-cert-badges">
          ...
          <span class="about-cert-dot">·</span>
          <span class="about-cert">PSM</span>
        </div>
      </div>
    </div>
...
<section class="offer">
  <div class="container">
    <div class="offer-card">
      ...
      <p class="offer-desc">3 à 4 séances de travail de 1h30 + analyse approfondie entre les séances.</p>
      ...
      <ul class="offer-list">
        ...
        <li>Trajectoire clarifiée : la prochaine étape choisie, et non subie.</li>
        <li>Plan d'action sur 90 jours, applicable dès la dernière séance.</li>
      </ul>

      <div class="offer-decision">
        <strong>À l'issue du diagnostic, vous avez une décision claire :</strong>
        Agir en autonomie en suivant votre plan — ou poursuivre avec le Programme R.P.T. sur 3 mois.
        Pas de vague. Du concret, uniquement.
      </div>
...
<section class="footer-cta">
  <div class="container">
    ...
    <p>30 minutes pour clarifier si vous souhaitez travailler votre rôle, votre posture et votre trajectoire.</p>
  ...
  <div class="container">
    <div class="footer-inner">
      ...
      <div class="footer-links">
        <a href="https://www.linkedin.com/in/ines-kouki-transformation-consultant/" target="_blank" class="footer-link">
